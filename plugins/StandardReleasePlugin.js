...
class StandardReleasePlugin {
    constructor() {
        this.name = 'standard-release';
        this.description = 'Standard release process for repositories with develop and master branches';
        this.version = '1.0.0';
    }
...
exports.default = StandardReleasePlugin;
//# sourceMappingURL=StandardReleasePlugin.js.map